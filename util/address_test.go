...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "nirvana:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			encoded: "nirvana:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixNirvana,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixNirvana)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixNirvana,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "nirvana:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			encoded: "nirvana:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixNirvana,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixNirvana,
			expectedPrefix: util.Bech32PrefixNirvana,
		},
		{
			name:    "testnet p2pk",
			addr:    "nirvanatest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			encoded: "nirvanatest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixNirvanaTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixNirvanaTest)
			},
			passedPrefix:   util.Bech32PrefixNirvanaTest,
			expectedPrefix: util.Bech32PrefixNirvanaTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "nirvana:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			encoded: "nirvana:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			valid:   true,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixNirvana)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixNirvana,
		},
		...
		},
		{
			...
			addr:           "nirvana:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixNirvana,
			expectedPrefix: util.Bech32PrefixNirvana,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "nirvana:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			encoded: "nirvana:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixNirvana)
			},
			passedPrefix:   util.Bech32PrefixNirvana,
			expectedPrefix: util.Bech32PrefixNirvana,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "nirvana:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			encoded: "nirvana:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixNirvana,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixNirvana)
			},
			passedPrefix:   util.Bech32PrefixNirvana,
			expectedPrefix: util.Bech32PrefixNirvana,
		},
		{
			name:    "testnet p2sh",
			addr:    "nirvanatest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			encoded: "nirvanatest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixNirvanaTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixNirvanaTest)
			},
			passedPrefix:   util.Bech32PrefixNirvanaTest,
			expectedPrefix: util.Bech32PrefixNirvanaTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"nirvanasim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvyqfusatdg",
			util.Bech32PrefixNirvanaSim,
			"unknown address type",
		},
		{
			"nirvanasim:raskzcg62uftfgk",
			util.Bech32PrefixNirvanaSim,
			"unknown address type",
		},
		{
			"nirvanatest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsyllsa7fye",
			util.Bech32PrefixNirvana,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"nirvana", util.Bech32PrefixNirvana, false},
		{"nirvanatest", util.Bech32PrefixNirvanaTest, false},
		{"nirvanasim", util.Bech32PrefixNirvanaSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixNirvana, "nirvana"},
		{util.Bech32PrefixNirvanaTest, "nirvanatest"},
		{util.Bech32PrefixNirvanaSim, "nirvanasim"},
		{util.Bech32PrefixUnknown, ""},
	}
