...
import (
	...
	"github.com/Nirvana-Chain/nirvanad/util/bech32"
)
...
const (
	...
	Bech32PrefixNirvanaDev

	// Prefix for the test network.
	Bech32PrefixNirvanaTest

	// Prefix for the simulation network.
	Bech32PrefixNirvanaSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"nirvana":     Bech32PrefixNirvana,
	"nirvanadev":  Bech32PrefixNirvanaDev,
	"nirvanatest": Bech32PrefixNirvanaTest,
	"nirvanasim":  Bech32PrefixNirvanaSim,
}
...
// and a payload which encodes the nirvana network and address type. It is used
...
// with the passed nirvana network.
