...
nirvana transaction scripts.

# Script Overview

Nirvana transaction scripts are written in a stack-base, FORTH-like language.

The nirvana script language consists of a number of opcodes which fall into
...
Typical nirvana scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend nirvana.
