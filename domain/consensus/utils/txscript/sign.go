...
// SignatureScript creates an input signature script for tx to spend NVA sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend NVA sent
