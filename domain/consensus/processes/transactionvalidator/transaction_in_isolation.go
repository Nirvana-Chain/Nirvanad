...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One nirvana is a quantity of sompi as defined by the
	// sompiPerNirvana constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Nirvana, but perhaps possible if an alt increases
