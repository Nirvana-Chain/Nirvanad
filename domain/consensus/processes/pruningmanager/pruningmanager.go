...
import (
	...
	"github.com/Nirvana-Chain/nirvanad/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that nirvanad doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
