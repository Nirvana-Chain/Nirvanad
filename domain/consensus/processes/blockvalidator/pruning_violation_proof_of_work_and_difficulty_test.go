...
import (
	...
	"github.com/Nirvana-Chain/nirvanad/domain/consensus/utils/merkle"
	"github.com/Nirvana-Chain/nirvanad/domain/consensus/utils/mining"
	"github.com/Nirvana-Chain/nirvanad/domain/consensus/utils/pow"
...
func TestPOW(t *testing.T) {
	...
	testutils.ForAllNets(t, false, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		if consensusConfig.Name != "nirvana-mainnet" {
