...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerNirvana
	defaultPreDeflationaryPhaseBaseSubsidy         = 50 * constants.SompiPerNirvana
	defaultDeflationaryPhaseBaseSubsidy            = 44 * constants.SompiPerNirvana
