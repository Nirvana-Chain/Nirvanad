...
// Params defines a Nirvana network by its parameters. These parameters may be
// used by Nirvana applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/Nirvana-Chain/research/issues/3
...
// MainnetParams defines the network parameters for the main Nirvana network.
var MainnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "nirvana-mainnet",
	Net:         appmessage.Mainnet,
	RPCPort:     "11810",
	DefaultPort: "11811",
	DNSSeeds: []string{
		// Team DNS seed
		"mainnet-dnsseed-1.nirvanacoin.net",
		"mainnet-dnsseed-2.nirvanacoin.net",
		"mainnet-dnsseed-3.nirvanacoin.net",
	},
	...
	Prefix: util.Bech32PrefixNirvana,
...
// TestnetParams defines the network parameters for the test Nirvana network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "nirvana-testnet-1",
	Net:         appmessage.Testnet,
	RPCPort:     "12810",
	DefaultPort: "12811",
	DNSSeeds: []string{
		"testnet-1.nirvanacoin.net",
	},
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixNirvanaTest,
...
// SimnetParams defines the network parameters for the simulation test Nirvana
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixNirvanaSim,
...
// DevnetParams defines the network parameters for the development Nirvana network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixNirvanaDev,
...
// ErrDuplicateNet describes an error where the parameters for a Nirvana
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Nirvana network")

var registeredNets = make(map[appmessage.NirvanaChain]struct{})

// Register registers the network parameters for a Nirvana network. This may
