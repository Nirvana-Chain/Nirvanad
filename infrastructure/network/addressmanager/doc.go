...
In order maintain the peer-to-peer Nirvana network, there needs to be a source
of addresses to connect to as nodes come and go. The Nirvana protocol provides
