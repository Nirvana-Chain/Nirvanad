...
func (x *NirvanadMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "NirvanadMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *NirvanadMessage_RequestPruningPointUTXOSet) fromAppMessage(
