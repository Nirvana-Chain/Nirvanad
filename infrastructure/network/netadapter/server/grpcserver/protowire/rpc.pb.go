...
//
// Clients are expected to build RequestMessages and wrap them in NirvanadMessage. (see messages.proto)
//
// Having received a RequestMessage, (wrapped in a NirvanadMessage) the RPC server will respond with a
// ResponseMessage (likewise wrapped in a NirvanadMessage) respective to the original RequestMessage.
//
...
// GetCurrentNetworkRequestMessage requests the network nirvanad is currently running against.
//
...
type GetBlockTemplateRequestMessage struct {
	...
	// Which nirvana address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether nirvanad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when nirvanad is not synced.
	// That is because when nirvanad isn't in sync with the rest of the network there's a high
...
// GetPeerAddressesRequestMessage requests the list of known nirvanad addresses in the
...
// currently connected to this nirvanad.
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this nirvanad initiated the connection
	...
	// The timestamp of when this peer connected to this nirvanad
...
// AddPeerRequestMessage adds a peer to nirvanad's outgoing connection list.
// This will, in most cases, result in nirvanad connecting to said peer.
...
// parent chain from some startHash to this nirvanad's current virtual
...
// GetBlockCountRequestMessage requests the current number of blocks in this nirvanad.
...
//
// This call is only available when this nirvanad was started with `--utxoindex`
//
...
// GetUtxosByAddressesRequestMessage requests all current UTXOs for the given nirvanad addresses
//
// This call is only available when this nirvanad was started with `--utxoindex`
...
var file_rpc_proto_rawDesc = []byte{
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0xe8, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x77, 0x69, 0x72, 0x65, 0x2e, 0x52, 0x50, 0x43, 0x45, 0x72, 0x72,
	0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x61, 0x72, 0x6c, 0x73, 0x65, 0x6e, 0x2d,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x6b, 0x61, 0x72, 0x6c, 0x73, 0x65, 0x6e, 0x64,
