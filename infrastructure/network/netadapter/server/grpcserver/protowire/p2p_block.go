...
func (x *NirvanadMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "NirvanadMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *NirvanadMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
