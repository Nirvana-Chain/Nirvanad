...
type P2P_MessageStreamClient interface {
	Send(*NirvanadMessage) error
	Recv() (*NirvanadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *NirvanadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*NirvanadMessage, error) {
	m := new(NirvanadMessage)
...
func (x *p2PMessageStreamServer) Send(m *NirvanadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*NirvanadMessage, error) {
	m := new(NirvanadMessage)
...
func (x *rPCMessageStreamClient) Send(m *NirvanadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*NirvanadMessage, error) {
	m := new(NirvanadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *NirvanadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*NirvanadMessage, error) {
	m := new(NirvanadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
