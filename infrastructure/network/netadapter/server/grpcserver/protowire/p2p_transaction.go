...
func (x *NirvanadMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "NirvanadMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *NirvanadMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
