...
func (x *NirvanadMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "NirvanadMessage_Addresses is nil")
	}
...
func (x *NirvanadMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
