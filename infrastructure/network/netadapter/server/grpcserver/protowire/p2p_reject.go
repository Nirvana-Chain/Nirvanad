...
func (x *NirvanadMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "NirvanadMessage_Reject is nil")
	}
...
func (x *NirvanadMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
