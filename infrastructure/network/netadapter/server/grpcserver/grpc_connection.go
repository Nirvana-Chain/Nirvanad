...
type grpcStream interface {
	Send(*protowire.NirvanadMessage) error
	Recv() (*protowire.NirvanadMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.NirvanadMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.NirvanadMessage) error {
