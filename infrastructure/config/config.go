...
const (
	defaultConfigFilename      = "nirvanad.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "nirvanad.log"
	defaultErrLogFilename      = "nirvanad_err.log"
	...
	sampleConfigFilename    = "sample-nirvanad.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for nirvanad.
	DefaultAppDir = util.AppDir("nirvanad", false)
...
// Flags defines the configuration options for nirvanad.
//
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 11811, testnet: 12811)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 11810, testnet: 12810)"`
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in NVA/kB to be considered a non-zero fee."`
...
// Config defines the configuration options for nirvanad.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default nirvanad configuration
...
//
// The above results in nirvanad functioning properly without any config settings
...
// createDefaultConfig copies the file sample-nirvanad.conf to the given destination path,
