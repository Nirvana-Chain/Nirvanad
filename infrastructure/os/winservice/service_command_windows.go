...
// installService attempts to install the nirvanad service. Typically this should
...
// removeService attempts to uninstall the nirvanad service. Typically this should
...
// startService attempts to Start the nirvanad service.
