...
// MsgRequestTransactions implements the Message interface and represents a nirvana
...
// NewMsgRequestTransactions returns a new nirvana RequestTransactions message that conforms to
