...
// MsgRequestNextHeaders implements the Message interface and represents a nirvana
...
// NewMsgRequestNextHeaders returns a new nirvana RequestNextHeaders message that conforms to the
// Message interface.
