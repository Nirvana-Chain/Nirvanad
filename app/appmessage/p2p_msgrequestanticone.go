...
// MsgRequestAnticone implements the Message interface and represents a nirvana
...
// NewMsgRequestAnticone returns a new nirvana RequestPastDiff message that conforms to the
