...
// MsgRequestAddresses implements the Message interface and represents a nirvana
...
// NewMsgRequestAddresses returns a new nirvana RequestAddresses message that conforms to the
