...
// MsgTransactionNotFound defines a nirvana TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new nirvana transactionsnotfound message that conforms to the
