...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a nirvana
...
// NewMsgDoneBlocksWithTrustedData returns a new nirvana DoneBlocksWithTrustedData message that conforms to the
// Message interface.
