...
// nirvana Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a nirvana
// Addresses message.
...
// NewMsgAddresses returns a new nirvana Addresses message that conforms to the
