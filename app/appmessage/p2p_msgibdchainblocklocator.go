...
// MsgIBDChainBlockLocator implements the Message interface and represents a nirvana
...
// NewMsgIBDChainBlockLocator returns a new nirvana locator message that conforms to
