...
// MsgRequestHeaders implements the Message interface and represents a nirvana
...
// NewMsgRequstHeaders returns a new nirvana RequestHeaders message that conforms to the
