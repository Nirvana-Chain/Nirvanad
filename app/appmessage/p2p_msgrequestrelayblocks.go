...
// MsgRequestRelayBlocks implements the Message interface and represents a nirvana
...
// NewMsgRequestRelayBlocks returns a new nirvana RequestRelayBlocks message that conforms to
