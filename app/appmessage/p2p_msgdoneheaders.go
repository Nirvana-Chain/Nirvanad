...
// MsgDoneHeaders implements the Message interface and represents a nirvana
...
// NewMsgDoneHeaders returns a new nirvana DoneIBDBlocks message that conforms to the
// Message interface.
