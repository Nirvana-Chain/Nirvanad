...
// RPCTransaction is a nirvanad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a nirvanad transaction input representation
...
// RPCScriptPublicKey is a nirvanad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a nirvanad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a nirvanad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a nirvanad utxo entry representation meant to be used
// over RPC
