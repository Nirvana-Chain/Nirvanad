...
var DefaultUserAgent = fmt.Sprintf("/nirvanad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a nirvana version
...
// NewMsgVersion returns a new nirvana version message that conforms to the
