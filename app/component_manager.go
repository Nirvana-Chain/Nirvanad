...
import (
	...
	"github.com/Nirvana-Chain/nirvanad/app/rpc"
	...
	"github.com/Nirvana-Chain/nirvanad/infrastructure/network/netadapter/id"
...
func (a *ComponentManager) Stop() {
	...
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Nirvanad is already in the process of shutting down")
		return
	}

	log.Warnf("Nirvanad shutting down")
